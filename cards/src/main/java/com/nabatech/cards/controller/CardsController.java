package com.nabatech.cards.controller;


import com.nabatech.cards.constants.CardsConstants;
import com.nabatech.cards.dto.CardsContactInfoDto;
import com.nabatech.cards.dto.CardsDto;
import com.nabatech.cards.dto.ErrorResponseDto;
import com.nabatech.cards.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Cards in NabaTech",
        description = "CRUD REST APIs in NabaTech to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside NabaTech"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    ResponseEntity<CardsContactInfoDto> contactInfo(){
        return ResponseEntity.
                ok().
